        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18 text-white">Edit Sektor: {{ $sektor->name }}</h4>
        ...
        <div class="col-lg-8">
            <div class="card card-modern">
                <div class="card-header card-header-modern">
                    <h4 class="card-title mb-0 text-white">Form Edit Sektor & Produk Domestik</h4>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="list-unstyled">
                        <li class="mb-3"><i class="mdi mdi-check-circle text-success me-2"></i>Data produk domestik lama
                            akan diganti total</li>
                        <li><i class="mdi mdi-check-circle text-success me-2"></i>Tahun tidak boleh duplikat dalam satu
                            sektor</li>
                    </ul>
                </div>
            </div>
...
@push('script')
    <script>
        let rowIndex = {{ $sektor->produkDomestik->count() || 1 }};
