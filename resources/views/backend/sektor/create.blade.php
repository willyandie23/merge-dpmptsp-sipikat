        ...
        <div class="col-lg-8">
            <div class="card card-modern">
                <div class="card-header card-header-modern">
                    <h4 class="card-title mb-0">Form Tambah Sektor & Produk Domestik</h4>
                </div>
            ...
            <div class="card tips-card">
                ...
                <div class="card-body">
                    <ul class="list-unstyled">
                        <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Nama sektor harus unik</li>
                        <li class="mb-2"><i class="mdi mdi-check-circle text-success me-2"></i>Tahun tidak boleh sama dalam
                            satu sektor</li>
                        <li><i class="mdi mdi-check-circle text-success me-2"></i>Nilai produk domestik dalam Rupiah</li>
                    </ul>
                </div>
            </div>
        </div>
