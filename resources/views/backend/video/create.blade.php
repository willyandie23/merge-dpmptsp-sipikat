        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">Tambah Video</h4>
        ...
        <div class="col-lg-8">
            <div class="card card-modern">
                <div class="card-header card-header-modern">
                    <h4 class="card-title mb-0">Form Tambah Video</h4>
                </div>
                    ...
                    <form action="{{ route('backend.video.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title"
                                ...
                                placeholder="Contoh: Tutorial Pengajuan Izin Usaha" required autofocus>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" rows="4"
                                ...
                                placeholder="Masukkan keterangan singkat video">{{ old('description') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="url" name="url" id="url" class="form-control @error('url') is-invalid @enderror"
                                value="{{ old('url') }}" placeholder="Contoh: https://www.youtube.com/watch?v=xxxxxxxxxxx"
                                required>
                            @error('url') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            <small class="form-text text-muted mt-2">Paste link YouTube atau Vimeo (akan otomatis
                                di-embed)</small>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="form-check form-switch form-switch-lg">
                                ...
                                <label class="form-check-label" for="is_active">Aktifkan video ini di halaman depan</label>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-3">
                            ...
                            <button type="submit" class="btn btn-gradient text-white">
                                <i class="mdi mdi-content-save me-1"></i> Simpan Video
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div class="col-lg-4">
            <div class="card tips-card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="mdi mdi-lightbulb-outline me-2"></i>Tips Video</h5>
                </div>
                <div class="card-body">
