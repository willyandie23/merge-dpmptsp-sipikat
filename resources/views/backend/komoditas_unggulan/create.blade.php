...
@section('title', 'Tambah Komoditas Unggulan')

@push('css')
    <style>
        /* CSS persis dari index (sama seperti sebelumnya) */
        .main-content {
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">Tambah Komoditas Unggulan</h4>
        ...
        <div class="col-lg-8">
            <div class="card card-modern">
                <div class="card-header card-header-modern">
                    <h4 class="card-title mb-0">Form Tambah Komoditas Unggulan</h4>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('backend.komoditas-unggulan.store') }}" method="POST"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title"
                                ...
                                placeholder="Contoh: Kopi Arabika Katingan" required autofocus>
                            @error('title') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="mb-4">
                            <label for="image" class="form-label">Upload Gambar Utama <span
            ...
            {{ old('description') }}
                        ...
                        <div class="d-flex justify-content-end gap-3">
                            ...
                            <button type="submit" class="btn btn-gradient text-white">
                                <i class="mdi mdi-content-save me-1"></i> Simpan Komoditas
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div class="col-lg-4">
            <div class="card tips-card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="mdi mdi-lightbulb-outline me-2"></i>Tips Komoditas Unggulan</h5>
                </div>
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        <li class="mb-3"><i class="mdi mdi-check-circle text-success me-2"></i>Gambar utama wajib landscape
                        </li>
                        <li class="mb-3"><i class="mdi mdi-check-circle text-success me-2"></i>Judul maksimal 100 karakter
                        </li>
                        <li><i class="mdi mdi-check-circle text-success me-2"></i>Deskripsi bisa diformat seperti majalah
                            (bold, list, heading, gambar)</li>
                    </ul>
                </div>
            </div>
        </div>
