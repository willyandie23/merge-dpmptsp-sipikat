        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18 text-white">Tambah Banner Baru</h4>
        ...
        <div class="col-lg-8">
            <div class="card card-modern">
                <div class="card-header card-header-modern">
                    <h4 class="card-title mb-0 text-white">Form Tambah Banner Dashboard</h4>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('backend.banner-dashboard.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
            ...
            <div class="card tips-card">
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="mb-3"><i class="mdi mdi-check-circle text-success me-2"></i>Gunakan foto landscape berkualitas tinggi</li>
                        <li class="mb-3"><i class="mdi mdi-check-circle text-success me-2"></i>Judul maksimal 100 karakter</li>
                        <li><i class="mdi mdi-check-circle text-success me-2"></i>Banner aktif akan muncul di dashboard</li>
                    </ul>
                </div>
            </div>
        </div>
