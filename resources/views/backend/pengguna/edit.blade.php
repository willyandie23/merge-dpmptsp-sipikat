        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18 text-white">Edit Pengguna</h4>
        ...
        <div class="col-lg-8">
            <div class="card card-modern">
                <div class="card-header card-header-modern">
                    <h4 class="card-title mb-0 text-white">Form Edit Pengguna</h4>
                </div>
                    ...
                    <form action="{{ route('backend.users.update', $user) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="role" class="form-control @error('role') is-invalid @enderror" required>
                                ...
                                @foreach ($roles as $role)
                                    <option value="{{ $role->id }}" {{ old('role', $userRoles[0] ?? '') == $role->id ? 'selected' : '' }}>
                                        {{ ucfirst($role->name) }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="d-flex justify-content-end gap-3">
                            ...
                            <button type="submit" class="btn btn-gradient text-white">
                                <i class="mdi mdi-content-save me-1"></i> Update Pengguna
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <div class="card tips-card">
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        <li class="mb-3"><i class="mdi mdi-check-circle text-success me-2"></i>Kosongkan password jika tidak
                            ingin mengubahnya</li>
                        <li><i class="mdi mdi-check-circle text-success me-2"></i>Jangan hapus akun Super Admin utama</li>
                    </ul>
                </div>
            </div>
        </div>
