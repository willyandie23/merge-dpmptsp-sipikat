        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18 text-white">Edit Bidang</h4>
                            ...
                            <div class="col-md-4">
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="position"
                                        ...
                                        value="{{ old('position', $bidang->position) }}" min="1" required>
                                    @error('position')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
            ...
            <div class="card tips-card">
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        ...
                        <li><i class="mdi mdi-check-circle text-success me-2"></i>Posisi harus unik (kecuali posisi saat
                            ini)</li>
                    </ul>
                </div>
            </div>
