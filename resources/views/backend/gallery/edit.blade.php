        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18 text-white">Edit Foto: {{ $gallery->title }}</h4>
        ...
        <div class="col-lg-8">
            <div class="card card-modern">
                <div class="card-header card-header-modern">
                    <h4 class="card-title mb-0 text-white">Form Edit Foto Galeri</h4>
                </div>
                    ...
                    <form action="{{ route('backend.gallery.update', $gallery) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" rows="4"
                                ...
                                placeholder="Masukkan keterangan singkat foto">{{ old('description', $gallery->description) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <small class="form-text text-muted mt-2">
                                Rekomendasi: <strong>1920×1080 px</strong> (Landscape) atau <strong>1080×1080 px</strong> (Square), max 2MB (jpg, png, webp)
                            </small>
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-3">
                            <a href="{{ route('backend.gallery.index') }}" class="btn btn-light">Batal</a>
                            <button type="submit" class="btn btn-gradient text-white">
                                <i class="mdi mdi-content-save me-1"></i> Update Foto
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <div class="card tips-card">
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        <li class="mb-3"><i class="mdi mdi-check-circle text-success me-2"></i>Rekomendasi ukuran: <strong>1920×1080 px</strong> (Landscape) atau <strong>1080×1080 px</strong> (Square)</li>
                        <li class="mb-3"><i class="mdi mdi-check-circle text-success me-2"></i>Ganti gambar akan otomatis menghapus file lama</li>
                        <li class="mb-3"><i class="mdi mdi-check-circle text-success me-2"></i>Gunakan foto yang berkualitas tinggi</li>
