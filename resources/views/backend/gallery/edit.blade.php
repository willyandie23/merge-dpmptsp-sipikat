        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">Edit Foto: {{ $gallery->title }}</h4>
        ...
        <div class="col-lg-8">
            <div class="card card-modern">
                <div class="card-header card-header-modern">
                    <h4 class="card-title mb-0">Form Edit Foto Galeri</h4>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('backend.gallery.update', $gallery) }}" method="POST"
                        ...
                        <div class="mb-4">
                            <div class="form-check form-switch form-switch-lg">
                                <input name="is_active" type="checkbox" class="form-check-input" id="is_active" value="1" {{ old('is_active', $gallery->is_active ? 1 : 0) ? 'checked' : '' }}>
