        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18 text-white">Tambah Foto Galeri</h4>
        ...
        <div class="col-lg-8">
            <div class="card card-modern">
                <div class="card-header card-header-modern">
                    <h4 class="card-title mb-0 text-white">Form Tambah Foto Galeri</h4>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('backend.gallery.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            <label for="image" class="form-label">Upload Foto Galeri <span class="text-danger">*</span></label>
                            <input type="file" name="image" id="image"
                                   class="form-control @error('image') is-invalid @enderror"
                                   accept="image/*" required>
                            @error('image') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            <small class="form-text text-muted mt-2">
                                Rekomendasi: <strong>1920x1080 px</strong> (Landscape) atau <strong>1080x1080 px</strong> (Square), max 2MB (jpg, png, webp)
                            </small>
                        </div>
            ...
            <div class="card tips-card">
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        <li class="mb-3"><i class="mdi mdi-check-circle text-success me-2"></i>Rekomendasi ukuran: <strong>1920×1080 px</strong> atau <strong>1080×1080 px</strong></li>
                        <li class="mb-3"><i class="mdi mdi-check-circle text-success me-2"></i>Gunakan foto berkualitas tinggi</li>
                        <li class="mb-3"><i class="mdi mdi-check-circle text-success me-2"></i>Judul maksimal 100 karakter</li>
                        <li><i class="mdi mdi-check-circle text-success me-2"></i>Foto yang aktif akan muncul di halaman galeri publik</li>
                    </ul>
                </div>
            </div>
        </div>
