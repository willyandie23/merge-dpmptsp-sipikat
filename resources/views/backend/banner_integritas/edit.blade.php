...
@section('title', 'Edit Banner Integritas')
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">Edit Banner: {{ $banner_integritas->title }}</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('backend.index') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('backend.banner-integritas.index') }}">Banner
                                    Integritas</a></li>
        ...
        <div class="col-lg-8">
            <div class="card card-modern">
                <div class="card-header card-header-modern">
                    <h4 class="card-title mb-0">Form Edit Banner Integritas</h4>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('backend.banner-integritas.update', $banner_integritas) }}" method="POST"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title"
                                ...
                                value="{{ old('title', $banner_integritas->title) }}" required autofocus>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" rows="4"
                                class="form-control @error('description') is-invalid @enderror">{{ old('description', $banner_integritas->description) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            @if ($banner_integritas->image)
                                <img src="{{ Storage::url($banner_integritas->image) }}" alt="{{ $banner_integritas->title }}"
                        ...
                        <div class="mb-4">
                            <div class="form-check form-switch form-switch-lg">
                                <input name="is_active" type="checkbox" class="form-check-input" id="is_active" value="1" {{ old('is_active', $banner_integritas->is_active ? 1 : 0) ? 'checked' : '' }}>
