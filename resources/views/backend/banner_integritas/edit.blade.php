        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18 text-white">Edit Banner: {{ $banner_integritas->title }}</h4>
        ...
        <div class="col-lg-8">
            <div class="card card-modern">
                <div class="card-header card-header-modern">
                    <h4 class="card-title mb-0 text-white">Form Edit Banner Integritas</h4>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('backend.banner-integritas.update', $banner_integritas) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="4"
                                ...
                                placeholder="Masukkan penjelasan singkat banner">{{ old('description', $banner_integritas->description) }}</textarea>
                        ...
                        <div class="mb-4">
                            <div class="form-check form-switch form-switch-lg">
                                ...
                                <input type="checkbox" name="is_active" id="is_active"
                                       ...
                                       {{ old('is_active', $banner_integritas->is_active) ? 'checked' : '' }}>
