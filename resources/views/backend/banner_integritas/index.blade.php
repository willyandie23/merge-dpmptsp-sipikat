...
@section('title', 'Manajemen Banner Integritas')
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">Manajemen Banner Integritas</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('backend.index') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Banner Integritas</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card card-modern">
                <div class="card-header card-header-modern d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">Daftar Banner Integritas</h4>
                    <a href="{{ route('backend.banner-integritas.create') }}" class="btn btn-light btn-add-banner">
                                ...
                                @forelse ($banners as $banner)
                                    <tr>
                                        ...
                                        <td class="aksi-column">
                                            <div class="btn-group">
                                                <a href="{{ route('backend.banner-integritas.edit', $banner) }}" class="btn btn-sm btn-warning">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center py-5 text-muted">
                                            ...
                                            Belum ada banner integritas tersimpan
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
            ...
            button.addEventListener('click', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.method = 'POST';
                        form.action = '{{ route("backend.banner-integritas.destroy", ":id") }}'.replace(':id', id);
