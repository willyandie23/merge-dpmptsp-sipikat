        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18 text-white">Edit Berita: {{ $news->title }}</h4>
        ...
        <div class="col-lg-8">
            <div class="card card-modern">
                <div class="card-header card-header-modern">
                    <h4 class="card-title mb-0 text-white">Form Edit Berita</h4>
                </div>
                    ...
                    <form action="{{ route('backend.news.update', $news) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-flex justify-content-end gap-3">
                            ...
                            <button type="submit" class="btn btn-gradient text-white">
                                <i class="mdi mdi-content-save me-1"></i> Update Berita
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <div class="card tips-card">
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        <li class="mb-3"><i class="mdi mdi-check-circle text-success me-2"></i>Gambar direkomendasikan <strong>1080 x 1080 px</strong> (Square)</li>
                        <li class="mb-3"><i class="mdi mdi-check-circle text-success me-2"></i>Ganti gambar akan otomatis mengganti file lama</li>
                        <li><i class="mdi mdi-check-circle text-success me-2"></i>Isi berita bisa diformat (bold, list, heading, tabel, dll)</li>
                    </ul>
                </div>
            </div>
        </div>
