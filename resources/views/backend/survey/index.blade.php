            ...
            const html = `
                        <div class="col-md-3">
                            <div class="card summary-card text-center p-4 h-100">
                                ...
                                <span class="summary-number fs-3 fw-bold text-primary">${totalLaki.toLocaleString('id-ID')}</span>
                        ...
                        <div class="col-md-3">
                            <div class="card summary-card text-center p-4 h-100">
                                ...
                                <span class="summary-number fs-3 fw-bold text-danger">${totalPerempuan.toLocaleString('id-ID')}</span>
                                <small class="text-muted">orang</small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="card summary-card text-center p-4 h-100">
                                ...
                                <span class="summary-number fs-3 fw-bold text-success">${totalResponden.toLocaleString('id-ID')}</span>
                                <small class="text-muted">orang</small>
                            </div>
                        </div>

                        <div class="col-md-3">
                            <div class="card summary-card text-center p-4 h-100 border-0"
                                 style="background: linear-gradient(135deg, #f8f9ff, #eef2ff);">
                                <h6 class="text-muted mb-3">IKM Tahun ${year}</h6>
                                <span class="summary-number fs-3 fw-bold text-success d-block mb-2">${rataRataIKM}</span>
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        fetch(`{{ route('backend.survey.destroy', ':id') }}`.replace(':id', currentSurveyId), {
                            ...
                            .then(response => {
                                if (response.ok) {
                                    return response.json().catch(() => ({})); // kalau tidak ada json, tetap lanjut
                                } else {
