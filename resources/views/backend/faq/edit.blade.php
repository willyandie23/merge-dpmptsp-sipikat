                ...
                <div class="card-body p-4">
                    <form action="{{ route('backend.faq.update', $faq) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="answer" id="editor-answer" class="form-control ckeditor">{{ old('answer', $faq->answer) }}</textarea>
    ...
    <div class="form-check form-switch form-switch-lg">
        ...
        <label class="form-check-label" for="is_active">Aktifkan FAQ ini di halaman depan</label>
                        ...
                        <div class="d-flex justify-content-end gap-3">
                            <a href="{{ route('backend.faq.index') }}" class="btn btn-light">Batal</a>
            ...
            <div class="card tips-card">
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="mb-3"><i class="mdi mdi-check-circle text-success me-2"></i>Jawaban boleh panjang dan menggunakan format CKEditor</li>
                        <li><i class="mdi mdi-check-circle text-success me-2"></i>FAQ yang diaktifkan akan tampil di halaman publik</li>
                    </ul>
                </div>
            </div>
        </div>
