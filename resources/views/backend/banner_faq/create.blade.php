...
@section('title', 'Tambah Banner FAQ')
    ...
    <div class="col-12">
        <div class="page-title-box">
            <div class="d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Tambah Banner FAQ</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('backend.index') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('backend.banner-faq.index') }}">Banner FAQ</a>
                        </li>
    ...
    <div class="col-lg-8">
        <div class="card card-modern">
            <div class="card-header card-header-modern">
                <h4 class="card-title mb-0">Form Tambah Banner FAQ</h4>
            </div>
            <div class="card-body p-4">
                <form action="{{ route('backend.banner-faq.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" id="title"
                            ...
                            placeholder="Contoh: FAQ Layanan Perizinan" required autofocus>
                    ...
                    <div class="mb-4">
                        <div class="form-check form-switch form-switch-lg">
                            ...
                            <label class="form-check-label" for="is_active">Aktifkan banner ini di halaman FAQ</label>
                        </div>
                    </div>

                    <div class="d-flex justify-content-end gap-3">
                        <a href="{{ route('backend.banner-faq.index') }}" class="btn btn-light waves-effect">
                            Batal
                        </a>
    ...
    <div class="col-lg-4">
        <div class="card tips-card">
            <div class="card-header">
                <h5 class="mb-0"><i class="mdi mdi-lightbulb-outline me-2"></i>Tips Banner FAQ</h5>
            </div>
            <div class="card-body">
                <ul class="list-unstyled mb-0">
                    <li class="mb-3"><i class="mdi mdi-check-circle text-success me-2"></i>Gunakan rasio landscape untuk
                        hasil optimal</li>
                    <li class="mb-3"><i class="mdi mdi-check-circle text-success me-2"></i>Judul maksimal 80-100
                        karakter</li>
                    <li><i class="mdi mdi-check-circle text-success me-2"></i>Banner aktif akan muncul di halaman FAQ
                    </li>
                </ul>
            </div>
        </div>
