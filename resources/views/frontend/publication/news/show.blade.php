...
@push('css')
    <style>
        ...
        /* Gambar original full square 1080x1080 */
        .news-hero-image {
            border-radius: 12px;
            overflow: hidden;
            ...
            <div class="col-12">
                ...
                <nav aria-label="breadcrumb" class="mt-2">
                    <ol class="breadcrumb mb-0" style="font-size: 0.82rem;">
                        ...
                        <li class="breadcrumb-item active text-muted">{{ Str::limit($newsItem->title, 40) }}</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-8 col-lg-8">
                <div class="dz-card blog-single style-1">
                    ...
                    {{-- Gambar Utama (ORIGINAL 1080x1080) --}}
                    @if ($newsItem->image)
                        <div class="news-hero-image mb-4">
                    ...
                    <div class="dz-info">
                        ...
                        <div class="dz-meta my-3">
                            <ul class="d-flex align-items-center gap-3 flex-wrap"
                                ...
                                <li class="d-flex align-items-center gap-1" style="font-size: 0.88rem;">
                        ...
                        {{-- Tombol Kembali --}}
                        <div class="dz-separator style-1 text-primary mt-5 mb-4"></div>
                    ...
                    <div class="widget widget-post">
                        ...
                        <ul class="mt-3" style="list-style: none; padding: 0;">
                            @foreach ($latestNews as $latest)
                                <li class="d-flex gap-3 mb-3 pb-3" style="border-bottom: 1px solid #f0f0f0;">
                                    @if ($latest->image)
